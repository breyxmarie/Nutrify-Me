          ...
          <Grid container spacing={2} sx={{ mt: "20px" }}>
            ...
            <Grid xs={12} md={4} sx={{ textAlign: "center" }}>
              ...
              <table style={{width:"150%"}}>
                      ...
                      <tr>
                        <td>Breakfast</td>
                        <td>₱ {parseInt((location.state.price / 5) * 0.32 )}</td>
                        <td>₱ {parseInt((location.state.price / 5) * 0.33 )}</td>
                        <td>₱ {parseInt((location.state.price / 5) * 0.25)}</td>

                        <td>₱ {parseInt((location.state.price / 5) * 0.33 )}</td>
                        <td>₱ {parseInt((location.state.price / 5) * 0.21 )}</td>

                      </tr>

                      <tr>
                        <td>Lunch</td>
                        <td>₱ {parseInt((location.state.price / 5) * 0.37) }</td>
                        <td>₱ {parseInt((location.state.price / 5) * 0.23)}</td>
                        <td>₱ {parseInt((location.state.price / 5) * 0.33 )}</td>

                        <td>₱ {parseInt((location.state.price / 5) * 0.32) }</td>
                        <td>₱ {parseInt((location.state.price / 5) * 0.35) }</td>

                      </tr>

                      <tr>
                        <td>Snack</td>
                        <td>₱ {parseInt((location.state.price / 5) * 0.1) }</td>
                        <td>₱ {parseInt((location.state.price / 5) * 0.115) }</td>
                        <td>₱ {parseInt((location.state.price / 5) * 0.12) }</td>

                        <td>₱ {parseInt((location.state.price / 5) * 0.11) }</td>
                        <td>₱ {parseInt((location.state.price / 5) * 0.125 )}</td>

                      </tr>
                      <tr>
                        <td>Dinner</td>
                        <td>₱ {parseInt((location.state.price / 5) * 0.21) }</td>
                        <td>₱ {parseInt((location.state.price / 5) * 0.31) }</td>
                        <td>₱ {parseInt((location.state.price / 5) * 0.32) }</td>

                        <td>₱ {parseInt((location.state.price / 5) * 0.22) }</td>
                        <td>₱ {parseInt((location.state.price / 5) * 0.325 )}</td>
